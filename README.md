...
Please download the **UnrealEgo dataset (01 ~ 06, impl 01 ~ 03)** on [our project page](https://vcai.mpi-inf.mpg.de/projects/UnrealEgo/). 
...
Please merge the downloaded the **UnrealEgo dataset (01 ~ 06, impl 01 ~ 03)** into a single **UnrealEgoData** folder as below. 
